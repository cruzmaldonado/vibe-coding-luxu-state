  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none opacity-40">
        <div className="absolute top-10 -right-24 w-96 h-96 bg-accent/30 rounded-full blur-3xl"></div>
        <div className="absolute bottom-10 -left-24 w-80 h-80 bg-mosque/10 rounded-full blur-3xl"></div>
      </div>
      <main className="w-full max-w-md z-10">
        ...
        <div className="bg-white dark:bg-[#152e2a] rounded-2xl shadow-soft p-8 sm:p-10 border border-white/50 dark:border-mosque/20 backdrop-blur-sm">
          ...
          <p className="mt-8 text-center text-sm text-nordic-dark/70 dark:text-gray-400">
            ...
            <Link className="font-semibold text-mosque hover:text-mosque-dark ml-1 transition-colors" href="#">Sign up</Link>
          </p>
        </div>
        <div className="mt-8 text-center">
          <nav className="flex justify-center gap-6 text-xs text-nordic-dark/50 dark:text-gray-500">
            <Link className="hover:text-nordic-dark dark:hover:text-gray-300 transition-colors" href="#">Privacy Policy</Link>
            <Link className="hover:text-nordic-dark dark:hover:text-gray-300 transition-colors" href="#">Terms of Service</Link>
            <Link className="hover:text-nordic-dark dark:hover:text-gray-300 transition-colors" href="#">Help Center</Link>
          </nav>
        </div>
      </main>
    </div>
