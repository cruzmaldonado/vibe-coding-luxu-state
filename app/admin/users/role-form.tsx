  ...
  return (
    <div className="flex items-center gap-2 justify-end w-full">
      ...
      {!disabled && (
        ...
        >
          <span className="material-icons text-xl">person_remove</span>
        </button>
      )}
          ...
          <div className="absolute top-full right-0 mt-2 w-48 rounded-lg shadow-lg bg-[#006655] ring-1 ring-black ring-opacity-5 overflow-hidden z-50 origin-top-right">
            <div className="py-1" role="menu" aria-orientation="vertical">
              ...
              <button
                onClick={handleDelete}
                disabled={disabled || isPending}
                className="w-full text-left group flex items-center px-4 py-3 text-xs text-red-200 hover:bg-red-500/20 hover:text-red-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                role="menuitem"
              >
